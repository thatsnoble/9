  ...
  , Jr = ({page: e})=>{
    ...
    const i = Pr(f=>f.data.auth)
      ...
      , a = ()=>{
        ...
        t(Su(!1)),
        console.log(i),
        window.open("https://www.fluxeva.com/", "_self")
    }
      , s = ()=>{
        document.cookie && document.cookie.split("authorization=")[1] !== void 0 && document.cookie.split("authorization=")[1].split(";")[0] !== void 0 && window.open("https://www.fluxeva.com/dashboard", "_self"),
        window.open("https://www.fluxeva.com/login", "_self")
    }
    ;
    return P("div", {
